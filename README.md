...
Services can be run by typing the command `docker compose up`. This will start the `Marimo` on [http://localhost:1357](http://localhost:1357), and you should be able to use `Python` from within the notebook by starting a new `Python` notebook.
